...
namespace Mahta.Utilities.SerilogRegistration.Enrichers;
public class MahtaApplicaitonEnricher : ILogEventEnricher
{
    private readonly SerilogApplicationEnricherOptions _options;
    public MahtaApplicaitonEnricher(IOptions<SerilogApplicationEnricherOptions> options)
    {
