using Mahta.Utilities.SoftwarePartDetector.Attributes;
using Mahta.Utilities.SoftwarePartDetector.DataModel;
using Microsoft.AspNetCore.Mvc.Controllers;
using Microsoft.AspNetCore.Mvc.Infrastructure;

namespace Mahta.Utilities.SoftwarePartDetector;
public class ControllersAndActionDetector
{
    ...
    public Task<List<SoftwarePartController>> Detect()
    {
        return Task.Run(() =>
        {
            ...
            {
                var attribute = item.ControllerTypeInfo
                                     .GetCustomAttributes(typeof(SoftwarePartControllerOptionAttribute), false)
