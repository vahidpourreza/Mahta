...
using Mahta.Utilities.Auth.ApiAuthentication.Options;

namespace Mahta.Extensions.DependencyInjection;

public static class ApiAuthenticationServiceCollectionExtensions
{
    public static IServiceCollection AddMahtaApiAuthentication(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddMahtaApiAuthentication(configuration.GetSection(sectionName));

    public static IServiceCollection AddMahtaApiAuthentication(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddMahtaApiAuthentication(this IServiceCollection services, Action<ApiAuthenticationOption> action)
    {
