...
namespace Mahta.Utilities.OpenTelemetryRegistration.Monitoring;
public class ResponseMetricMiddleware(RequestDelegate request)
{
    ...
    public async Task Invoke(HttpContext httpContext, MetricReporter reporter)
    {
        ...
        finally
        {
            ...
            reporter.RegisterResponseTime(httpContext.Response.StatusCode, httpContext.Request.Method, path, sw.Elapsed);
        }
    }
