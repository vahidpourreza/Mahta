using Mahta.Core.Contracts.Data.Commands;
using Mahta.Core.Domain.Entities;
using Mahta.Core.Domain.ValueObjects;
using System.Linq.Expressions;

namespace Mahta.Infra.Data.Sql.Commands;


public class BaseCommandRepository<TEntity, TDbContext, TId> : ICommandRepository<TEntity, TId>, IUnitOfWork
    where TEntity : AggregateRoot<TId> where TDbContext : BaseCommandDbContext where TId : struct,
          IComparable, IComparable<TId>, IConvertible, IEquatable<TId>, IFormattable
{
...
public class BaseCommandRepository<TEntity, TDbContext> : BaseCommandRepository<TEntity, TDbContext, long>
    where TEntity : AggregateRoot where TDbContext : BaseCommandDbContext
{
