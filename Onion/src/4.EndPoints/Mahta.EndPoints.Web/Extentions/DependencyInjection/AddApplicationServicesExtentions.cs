using Mahta.Core.ApplicationServices.Commands;
using Mahta.Core.ApplicationServices.Events;
using Mahta.Core.ApplicationServices.Queries;
...
{
    public static IServiceCollection AddMahtaApplicationServices(this IServiceCollection services, IEnumerable<Assembly> assembliesForSearch)
