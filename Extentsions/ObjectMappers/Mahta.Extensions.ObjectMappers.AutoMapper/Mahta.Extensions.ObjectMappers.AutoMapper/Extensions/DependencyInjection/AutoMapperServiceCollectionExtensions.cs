...
using Mahta.Extensions.ObjectMappers.AutoMapper.Options;
using Mahta.Extensions.ObjectMappers.AutoMapper.Services;
...
public static class AutoMapperServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddMahtaAutoMapperProfiles(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddMahtaAutoMapperProfiles(configuration.GetSection(sectionName));

    public static IServiceCollection AddMahtaAutoMapperProfiles(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddMahtaAutoMapperProfiles(this IServiceCollection services, Action<AutoMapperOption> setupAction)
    {
