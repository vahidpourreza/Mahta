using Dapper;
using Mahta.Extensions.Translations.Parrot.DataModel;
using Mahta.Extensions.Translations.Parrot.Options;
using Microsoft.Data.SqlClient;
using Microsoft.Extensions.Logging;
using System.Data;

namespace Mahta.Extensions.Translations.Parrot.Database;
...
public class ParrotSqlRepository
{
    ...
    public ParrotSqlRepository(ParrotTranslatorOptions configuration, ILogger logger)
    {
        ...
        _ = new Timer(LoadLocalizationRecords,null,TimeSpan.FromMinutes(configuration.ReloadDataIntervalInMinuts),
