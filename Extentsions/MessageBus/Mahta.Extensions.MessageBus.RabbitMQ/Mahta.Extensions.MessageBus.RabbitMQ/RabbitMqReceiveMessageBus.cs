...
using Mahta.Extensions.MessageBus.RabbitMQ.Extensions;
...
public class RabbitMqReceiveMessageBus : IReceiveMessageBus, IDisposable
{
    ...
    public RabbitMqReceiveMessageBus(IConnection connection, ILogger<RabbitMqReceiveMessageBus> logger,
                                     IOptions<RabbitMqOptions> rabbitMqOptions, IServiceScopeFactory serviceScopeFactory)
    {
        _logger = logger;
