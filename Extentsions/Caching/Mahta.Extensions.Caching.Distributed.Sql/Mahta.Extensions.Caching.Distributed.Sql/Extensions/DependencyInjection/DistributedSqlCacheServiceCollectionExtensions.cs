...
using Mahta.Extensions.Caching.Distributed.Sql.Options;
using Mahta.Extensions.Caching.Distributed.Sql.Services;
...
{
    public static IServiceCollection AddMahtaSqlDistributedCache(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddMahtaSqlDistributedCache(configuration.GetSection(sectionName));

    public static IServiceCollection AddMahtaSqlDistributedCache(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddMahtaSqlDistributedCache(this IServiceCollection services, Action<DistributedSqlCacheOptions> setupAction)
    {
        services.AddTransient<ICacheAdapter, DistributedSqlCacheAdapter>();
