...
namespace Mahta.Extensions.Serializers.Microsoft.Services;
...
public class MicrosoftSerializer : IJsonSerializer, IDisposable
{
    ...
    public TOutput Deserialize<TOutput>(string input)
    {
        ...
        return string.IsNullOrWhiteSpace(input) ? default : JsonSerializer.Deserialize<TOutput>(input, options);
    }
    ...
    public object Deserialize(string input, Type type)
    {
        ...
        return string.IsNullOrWhiteSpace(input) ? default : JsonSerializer.Deserialize(input, type, options);
    }
