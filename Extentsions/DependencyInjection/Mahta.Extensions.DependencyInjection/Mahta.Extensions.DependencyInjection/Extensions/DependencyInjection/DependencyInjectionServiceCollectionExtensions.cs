...
using Mahta.Extensions.DependencyInjection.Options;
...
public static class DependencyInjectionServiceCollectionExtensions
{
    public static IServiceCollection AddCustomDependencies(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            .AddWithTransientLifetime(option.AssemblyNamesForLoad)
            .AddWithScopeLifetime(option.AssemblyNamesForLoad)
            .AddWithSingletoneLifetime(option.AssemblyNamesForLoad)
    ...
    private static IServiceCollection AddWithSingletoneLifetime(this IServiceCollection services, string assemblyNames)
        => services.Scan(s => s.FromAssemblies(GetAssemblies(assemblyNames))
